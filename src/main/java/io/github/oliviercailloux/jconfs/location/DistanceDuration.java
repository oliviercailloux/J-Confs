...
/**
 * This class allows to get a path and informations about it. A trajet is define beetween two
 * addresses (see Address class). Using LocationIQ "DirectionsAPI" you can get the total distance
 * (in meters) and duration (in seconds) for the journey. The global informations about the path
 * (stored in a Step object) can be get using getGeneralStep method. You can also get all the steps
 * of the journey (stored as a List<Step>) using getAllSteps method.
 * 
...
public class DistanceDuration {
  ...
  /**
   * Distance and Duration of generalStep are temporally set to -1 and will be calculate by calling
   * locationIQ API
   * 
   */
  ...
  /**
   * Return the generalStep composed of the departure and arrival address and the global distance
   * and duration. It verified if the distance and the duration had been calculated and otherwise it
   * use locationIQ to calculate it.
   * 
   * 
   * @return generalStep
   * @throws ApiException
  ...
  /**
   * This function use the LocataionIQ "DirectionsAPI" to calculates the duration, the distance and
   * all the informations about the path between the two addresses of the class.
   * 
   * @throws ApiException
   */
  private void calculateDistanceDuration() throws ApiException {
    ...
    DirectionsDirections response =
        api.directions(latLonAddressDeparture + ";" + latLonAddressArrival, null, null, null, null,
            null, null, "true", null, null, "simplified", null);
    ...
    this.generalStep = Step.newStep(this.generalStep.getDepartureAddress(),
        this.generalStep.getArrivalAddress(), distance, duration);
