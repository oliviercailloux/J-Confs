...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Document_use_case_diagram.PNG[alt="Document use case diagram",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Document_s_class_diagram.PNG[alt="Document class diagram",width=80%,height=80%, align="center"]
