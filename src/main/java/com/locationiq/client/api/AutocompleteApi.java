...
public class AutocompleteApi {
	 ...
	 * @param tag            Restricts the autocomplete search results to elements
	 *                       of specific OSM class and type. Example - To restrict
	 *                       results to only class place and type city:
	 *                       tag&#x3D;place:city, To restrict the results to all of
	 *                       OSM class place: tag&#x3D;place (optional)
	 ...
	 *                        </table>
	 */
	public okhttp3.Call autocompleteCall(String q, Integer normalizecity, Integer limit, String viewbox,
			Integer bounded, String countrycodes, String acceptLanguage, String tag, final ApiCallback _callback)
			throws ApiException {
	...
	private okhttp3.Call autocompleteValidateBeforeCall(String q, Integer normalizecity, Integer limit, String viewbox,
			Integer bounded, String countrycodes, String acceptLanguage, String tag, final ApiCallback _callback)
			throws ApiException {
		...
		okhttp3.Call localVarCall = autocompleteCall(q, normalizecity, limit, viewbox, bounded, countrycodes,
				acceptLanguage, tag, _callback);
		return localVarCall;
	...
	/**
	 * 
	 * The Autocomplete API is a variant of the Search API that returns place
	 ...
	 * user types. The Autocomplete API can match on full words as well as
	 ...
	 *                        </table>
	 */
	public List<Object> autocomplete(String q, Integer normalizecity, Integer limit, String viewbox, Integer bounded,
			String countrycodes, String acceptLanguage, String tag) throws ApiException {
		ApiResponse<List<Object>> localVarResp = autocompleteWithHttpInfo(q, normalizecity, limit, viewbox, bounded,
				countrycodes, acceptLanguage, tag);
	 ...
	 *                        </table>
	 */
	public ApiResponse<List<Object>> autocompleteWithHttpInfo(String q, Integer normalizecity, Integer limit,
			String viewbox, Integer bounded, String countrycodes, String acceptLanguage, String tag)
			throws ApiException {
		okhttp3.Call localVarCall = autocompleteValidateBeforeCall(q, normalizecity, limit, viewbox, bounded,
				countrycodes, acceptLanguage, tag, null);
	...
	/**
	 * (asynchronously) The Autocomplete API is a variant of the Search API that
	 * returns place predictions in response to an HTTP request. The request
	 * specifies a textual search string and optional geographic bounds. The service
	 * can be used to provide autocomplete functionality for text-based geographic
	 * searches, by returning places such as businesses, addresses and points of
	 * interest as a user types. The Autocomplete API can match on full words as
	 * well as substrings. Applications can therefore send queries as the user
	 ...
	 *                        </table>
	 */
	public okhttp3.Call autocompleteAsync(String q, Integer normalizecity, Integer limit, String viewbox,
			Integer bounded, String countrycodes, String acceptLanguage, String tag,
