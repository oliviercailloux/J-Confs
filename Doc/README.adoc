...
== Link to a documentation explaining the relationships between the Evolution application, the Fruux website, and the J-Confs software
...
== Link to a documentation explaining the format used to store a conference
...
== Link to a documentation explaining the modifications needed in java unit tests
* https://github.com/oliviercailloux-org/projet-j-confs/blob/main/Doc/Prequisities%20JUnit%20tests.adoc[Prerequisities JUnit tests]
