...
class AddressQuerierTest {
	...
	@Test
	public final void testRecoveryAddressInformations() throws ApiException, InterruptedException, JsonIOException,
	...
	@Test
	public final void testRecoveryAddressFound() throws ApiException, InterruptedException, JsonIOException,
			JsonSyntaxException, IOException, ParseException {
		AddressQuerier t = AddressQuerier.given("Université paris dauphine");
		TimeUnit.SECONDS.sleep(1);
