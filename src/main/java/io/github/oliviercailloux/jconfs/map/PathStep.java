...
/*
 * An object of PathStep represents a path step of a conference with parameters (type of transport,
 * departure and arrival place) that describe this path
 * 
 */
public class PathStep {
  ...
  /**
   * this is a constructor which initializes the PathStep object The TransporType is noTranport by
   * default
   * 
  ...
  public String toString() {
    return MoreObjects.toStringHelper(this).add("StartingPoint", starting)
        .add("ArrivalPoint", arrival).add("Type", type).toString();
  }
}
