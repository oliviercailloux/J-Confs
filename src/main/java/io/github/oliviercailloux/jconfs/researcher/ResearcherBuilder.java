...
public class ResearcherBuilder {
   ...
   */
  public static Researcher create(String login) throws ClassNotFoundException,
    ...
    researcher
        .setFunction(Objects.requireNonNull(listElements.item(2).getFirstChild().getTextContent()));
    researcher.setPhone(
        Objects.requireNonNull(listElements.item(4).getFirstChild().getTextContent().trim()));
    researcher.setOffice(
        Objects.requireNonNull(listElements.item(8).getFirstChild().getTextContent().trim()));
    researcher.setMail(
        Objects.requireNonNull(listElements.item(10).getFirstChild().getTextContent().trim()));
