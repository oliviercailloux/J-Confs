...
First you need to create some account. https://github.com/oliviercailloux-org/projet-j-confs/blob/main/Doc/Prerequisites%20CalendarOnline.adoc[Please refer to this doc]


The package calendar permits to use an online calendar or to use a local file calendar with limited options. To use an online calendar you need first, to set credential providers in order to connect to the calendar, thanks to JARiS.

image:https://github.com/oliviercailloux-org/projet-j-confs/blob/main/Doc/Papyrus/Diagrams/JARiS_use_case_diagramm.SVG[alt="JARiS use case diagram",width=80%,height=80%, align="center"]

image:https://github.com/oliviercailloux-org/projet-j-confs/blob/main/Doc/Papyrus/Diagrams/CredentialsReader_Class_Diagramm.SVG[alt="JARiS Class diagram",width=80%,height=80%, align="center"]
