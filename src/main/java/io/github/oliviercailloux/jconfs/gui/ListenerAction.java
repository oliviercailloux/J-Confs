...
/**
 * @author nikola Class that contains common methods for verification of text fields
 */
public class ListenerAction {

  /**
   * check if the character is a letter or "-" or a whitespace, if not you can't put the character
   */
