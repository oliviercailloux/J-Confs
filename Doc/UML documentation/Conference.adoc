...
* The ConferenceBuilder class instantiate a conference and validate only if it contains Uid, Title, startDate and endDate
...
In the code, a conference won't exist if it doesn't have a uid, a title, a start date and an end date. It will throw an IllegalStateException.
