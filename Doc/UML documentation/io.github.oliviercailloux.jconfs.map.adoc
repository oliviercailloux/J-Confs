...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/map_s_class_diagram.PNG[alt="Calendar View.",width=80%,height=80%, align="center"]
