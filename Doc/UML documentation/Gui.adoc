...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Gui_use_case_diagram.SVG[alt="Gui use case diagram",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Gui_s_class_diagram.SVG[alt="Calendar View.",width=80%,height=80%, align="center"]
