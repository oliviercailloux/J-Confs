...
=== Delivery 2 
	* *Tasks TO DO*
	    ...
	    . About packages : => *Warning : Creation of packages reported to the next delivery due to errors*
	        .. Delete the package "y2018" and then check the package structure
	        .. Create package in order to better divide the code depending on the dependencies between classes :
                **   Gui
                **   Conference
                **   Geo
