...
public class BalanceApi {
  ...
  /**
   * 
   * The Balance API provides a count of request credits left in the user&#39;s account for the day.
   * Balance is reset at midnight UTC everyday (00:00 UTC).
   * 
   * @return Balance
  ...
  /**
   * (asynchronously) The Balance API provides a count of request credits left in the user&#39;s
