...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Researcher_use_case_diagram.SVG[alt="Researcher use case diagram",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Researcher_s_class_diagram.SVG[alt="Researcher class diagram",width=80%,height=80%, align="center"]
