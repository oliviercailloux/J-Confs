...
public class ReverseApi {
	 ...
	 *                       Defaults to 1. (optional, default to 1)
	 ...
	 * @param showdistance   Returns the straight line distance (meters) between the
	 *                       input location and the result&#39;s location. Value is
	 *                       set in the distance key of the response. Defaults to 0
	 *                       [0,1] (optional)
	 ...
	 *                        </table>
	 */
	public okhttp3.Call reverseCall(BigDecimal lat, BigDecimal lon, String format, Integer normalizecity,
			Integer addressdetails, String acceptLanguage, Integer namedetails, Integer extratags, Integer statecode,
			Integer showdistance, Integer postaladdress, final ApiCallback _callback) throws ApiException {
	...
	private okhttp3.Call reverseValidateBeforeCall(BigDecimal lat, BigDecimal lon, String format, Integer normalizecity,
			Integer addressdetails, String acceptLanguage, Integer namedetails, Integer extratags, Integer statecode,
			Integer showdistance, Integer postaladdress, final ApiCallback _callback) throws ApiException {
		...
		okhttp3.Call localVarCall = reverseCall(lat, lon, format, normalizecity, addressdetails, acceptLanguage,
	...
	/**
	 * Reverse Geocoding Reverse geocoding is the process of converting a coordinate
	 * or location (latitude, longitude) to a readable address or place name. This
	 * permits the identification of nearby street addresses, places, and/or area
	...
	public Location reverse(BigDecimal lat, BigDecimal lon, String format, Integer normalizecity,
			Integer addressdetails, String acceptLanguage, Integer namedetails, Integer extratags, Integer statecode,
			Integer showdistance, Integer postaladdress) throws ApiException {
		ApiResponse<Location> localVarResp = reverseWithHttpInfo(lat, lon, format, normalizecity, addressdetails,
				acceptLanguage, namedetails, extratags, statecode, showdistance, postaladdress);
	...
	public ApiResponse<Location> reverseWithHttpInfo(BigDecimal lat, BigDecimal lon, String format,
			...
			Integer extratags, Integer statecode, Integer showdistance, Integer postaladdress) throws ApiException {
		okhttp3.Call localVarCall = reverseValidateBeforeCall(lat, lon, format, normalizecity, addressdetails,
				acceptLanguage, namedetails, extratags, statecode, showdistance, postaladdress, null);
		Type localVarReturnType = new TypeToken<Location>() {
		}.getType();
		return localVarApiClient.execute(localVarCall, localVarReturnType);
	}

	/**
	 * Reverse Geocoding (asynchronously) Reverse geocoding is the process of
	 * converting a coordinate or location (latitude, longitude) to a readable
	 * address or place name. This permits the identification of nearby street
	 * addresses, places, and/or area subdivisions such as a neighborhood, county,
	 * state, or country.
	 * 
	 * @param lat            Latitude of the location to generate an address for.
	 *                       (required)
	 ...
	 *                        </table>
	 */
	public okhttp3.Call reverseAsync(BigDecimal lat, BigDecimal lon, String format, Integer normalizecity,
			Integer addressdetails, String acceptLanguage, Integer namedetails, Integer extratags, Integer statecode,
			Integer showdistance, Integer postaladdress, final ApiCallback<Location> _callback) throws ApiException {
