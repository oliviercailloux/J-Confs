...
First you need to create some account. https://github.com/sebastienbourg/J-Confs/blob/master/Doc/CalendarOnline%20Documentation.adoc[Please refer to this doc]
