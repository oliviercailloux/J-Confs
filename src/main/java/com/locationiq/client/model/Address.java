...
public class Address {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(houseNumber, road, residential, borough, neighbourhood, quarter, hamlet,
        suburb, island, village, town, city, cityDistrict, county, state, stateDistrict, postcode,
        country, countryCode, stateCode);
  }
