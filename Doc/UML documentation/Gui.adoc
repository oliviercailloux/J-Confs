...
Actually one action can work (search a researcher), the others can be improved in order to become operational, for this you can use an *MVC* architecture (Model-View-Controller) for this you can use an *MVC* architecture to associate events and methods, for example to:
