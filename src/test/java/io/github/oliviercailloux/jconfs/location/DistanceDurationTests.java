...
class DistanceDurationTests {
	...
	/**
	 * 
	 * Unit test in order to verify the good get of distance and duration. We are
	 * checking that the distance between the departure and the arrival is between
	 * 5000 m and 15000 m because it can fluctuate depending on the API used. It's
	 * the same idea for the duration (between 1000 seconds and 2000 seconds) and
	 * the number of steps (between 100 and 200 steps)
	 * 
