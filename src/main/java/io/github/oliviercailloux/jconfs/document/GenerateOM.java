...
public class GenerateOM {
  ...
  private static String target =
      FileSystems.getDefault().getPath("").toAbsolutePath() + "/ordre_de_mission_test.ods";
  ...
  private static void saveOrderMissionToHistory(String fileToCopy, String city, String country,
