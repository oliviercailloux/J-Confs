...
public class GuiConference {
	...
	public static void Gui(Display display) {
		...
		buttonSubmit.addSelectionListener(new SelectionAdapter() {
			// this function save the value in the fields of GUI in a conference
			// and write-read a ICalendar
			public void widgetSelected(SelectionEvent event) {
				...
				// add "O" before the day and month if they are 1, 2, 3, 4, 5,
				// 6, 7, 8, 9
		...
		buttonGenerate.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent event) {
				// this function save the value in the fields of GUI in a
				// conference and fill the mission order
		...
		// //GuiListConferences gulist=new
		// GuiListConferences(txt_login.getText());
		// }
		// });
