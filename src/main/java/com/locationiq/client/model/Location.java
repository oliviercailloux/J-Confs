...
public class Location {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(distance, placeId, licence, osmType, osmId, boundingbox, lat, lon,
        displayName, propertyClass, type, importance, address, namedetails, matchquality);
  }
