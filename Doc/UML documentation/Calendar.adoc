...
In this package that is represented in Papyrus, we have 4 classes : CalendarOnline, CalendarConnector, UserCredentials and ReadCalendarFiles. CalendarOnline manage a calendar. CalendarConnector connect to the calendar. UserCredentials read a file and give ReadCalendarFiles helps us to create conference and read Calendar.
