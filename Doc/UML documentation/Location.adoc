...
The constructor of this class takes two addresses (of type Address) as parameters and in order to get latitude and longitude corresponding to this addresses. 
...
This class allows to store an address as a specific location. We define it as a latitude, a longitude and a postal address as a String.
