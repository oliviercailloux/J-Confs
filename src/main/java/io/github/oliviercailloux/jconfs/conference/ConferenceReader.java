...
public class ConferenceReader {
  ...
  public static void readCalendarFile(Reader read)
      throws IOException, ParserException, NumberFormatException {
   ...
   * 
   * @param date Not {@code null} it's the date that we want to change its pattern.
   * 
