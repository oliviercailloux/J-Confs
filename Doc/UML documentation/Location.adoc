...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Location_use_case_diagram.SVG[alt="Location use case",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/locationIQ_class_diagram.SVG[alt="Location class",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Sequence_Diagram_AddressQuerier_requestAddressInformations.SVG[alt="AddressQuerier recoveryAddressInformations Sequence diagram",width=80%,height=80%, align="center"]
...
image:https://github.com/sebastienbourg/J-Confs/blob/master/Doc/Papyrus/Diagrams/Sequence_Diagram_DistanceDuration_calculateDistanceDuration.SVG[alt="DistanceDuration calculateDistanceDuration Sequence diagram",width=90%,height=90%, align="center"]
