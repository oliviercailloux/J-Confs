...
We will migrate all LocalDate into Instant. Double will became a String. This will help us to extend the price property. We will implement the Builder design pattern into Conference in order to avoid the use of null value in Calendar function.
