...
We will make a location class that will have for attribute latitudeDep, longitudDep, latitudeArr, longitudeArr, villeDep, villeArr. This action will also be feasible in the other direction.
